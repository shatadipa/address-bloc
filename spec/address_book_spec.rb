...
#we assume that there are 5 entries in AddressBook
  describe '#import_from_csv' do
    ...
    it 'imports 1st entry from entries_2.csv' do
      ...
      entry_one=book.entries[0]
      check_entry(entry_one,'Billy','555-500-4854','billy@blocmail.com')
    end
    ...
    it 'imports 1st entry from entries_2.csv' do
      book.import_from_csv('entries_2.csv')
      entry_two=book.entries[1]
      check_entry(entry_two,'Bobby','555-555-5015','bobby@blocmail.com')
    end
    ...
    it 'imports 1st entry from entries_2.csv' do
      book.import_from_csv('entries_2.csv')
      entry_three=book.entries[2]
      check_entry(entry_three,'Joeye','555-555-3000','joeye@blocmail.com')
    end
  end
